...
//
// var MICROSOFT_APP_ID = process.env.MICROSOFT_APP_ID || '57a5ff36-24a6-49ec-8d25-1fc78ba28c52';
// var MICROSOFT_APP_PASSWORD = process.env.MICROSOFT_APP_PASSWORD || 'plnQQ4048|%)luoaVPQXT6@';
//
// //0ae52b285aa14cdd957662eca29b22bd
// //a9a59239d0214519bbcf44d41ca4f784
//
// var header = {'Content-Type':'application/json', 'Ocp-Apim-Subscription-Key': 'a9a59239d0214519bbcf44d41ca4f784'}
// var requestUrl = 'https://westcentralus.api.cognitive.microsoft.com/text/analytics/v2.0/languages';
//
// var task;
// // Setup Restify Server
// var server = restify.createServer();
...
//                 .text("Hello Charlie, I'm a bot! How's your day going?");
//         console.log(reply)
//         bot.send(reply);
//     }
// });
...
//             // console.log(parsedBody.documents[0].detectedLanguages[0].score)
//             var score = parsedBody.documents[0].detectedLanguages[0].score.toString();
//             if(score > 0.80) {                    // happy
...
//
//     console.log('sendGetSentimentRequest')
